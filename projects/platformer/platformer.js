$(function () {
  ...
  function setup() {
    ...
    createPlatform(20, 750, 200, 10);
    createPlatform(40, 700, 200, 10);
    createPlatform(60, 650, 200, 10); // short but wide platform located 500 pixels from the left of the screen and 300 pixels from the top of the screen
    ...
    createCollectable("steve", 200, 200, 10, 0.5); // creates a "steve" collectible at the coordinates (500, 300), falling with a high gravity of 20, and bouncing with 50% bounce
